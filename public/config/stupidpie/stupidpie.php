...
* Since we are using Bing RSS, StupidPie no longer able to fetch image (ã„’_ã„’)
* Since we are using Bing RSS, We no longer limited to 5000 query per month ï¼¼(^Ï‰^ï¼¼)
*/
